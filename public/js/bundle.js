...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2lrMjAiLCJhIjoiY2xycmt3emk1MDA5MTJrbzNtY2dnMjNsYiJ9.M7TF_-ioHQ5qJB5tOElmxA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/sik20/clrrm8a9300fu01r4bw2566o6',
    scrollZoom: false //   center: [-118.4131058, 34.020479],
    //   zoom: 7,
    //   interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); //add pop

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " ").concat(loc.description, " </p>")).addTo(map); //extend the map bounds to fit the current location
  ...
  _regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          console.log('clicked'); // reloading from the server vs browser
  ...
  _regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          console.log(res); ///?? dont get why 'sucess works instead of sucess

          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), "account details updated succesfully'"));
...
var stripe = Stripe('pk_test_51Oeu9YK2LMvq3TCM4uhpkxayIYzlUiUo4bq2dYlAH9DTEOsQdxQJPLeA6Rporm4sI2Zhf4aSN6KNHKZhiRvMcP7d00gg0oDSU5');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          console.log((0, _alerts.showAlert)('error', _context.t0));
...
var updateMeForm = document.querySelector('.form-user-data');
...
if (updateMeForm) {
  updateMeForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)(form, 'User Details');
  });
}
...
if (userPasswordForm) {
  ...
  function () {
    ...
    _regeneratorRuntime().mark(function _callee(e) {
      var renterPassword, newPassword, newPasswordConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--save--password').textContent = 'Updating...';
            renterPassword = document.getElementById('password-current').value;
